...
import { authController, otpController, userController } from "../controllers/index.js";

const router = express.Router();

router.post("/auth/register/local", authController.emailRegister);
...
router.post("/auth/reset-password", authentication, userController.resetPassword)
